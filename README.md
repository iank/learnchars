...
Update vocabulary list from Skritter. The auth token below is found by logging
in to the web UI and examining the network traffic generated by their front
end. I'm sure the script could do its own authentication, but I haven't gotten
around to it.

    ./scripts/skritter_dl.py xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx > ../skritter.tsv
